...
import com.example.bbuniversity.etudiant.StudentGradesActivity;
...
public class StudentDashboard extends AppCompatActivity {
    ...
    private MaterialButton btnViewGrades;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvViewAllGrades = findViewById(R.id.tvViewAllGrades); // lien pour tout voir
        btnViewGrades = findViewById(R.id.btnViewGrades); // bouton pour toutes les notes
